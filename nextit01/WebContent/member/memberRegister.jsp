...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/css/memberRegister.css">
</head>
<body>
	...
	<%
		...
		try {
			...
			rs.next();
			int rowCount = rs.getInt(1); // 첫번째 결과값을 int형으로 반환
	...
	<div class="container">
		...
		<c:if test="${bde ne null }">
			...
			<div class="alert alert-warning">
				<p>이미 사용중인 아이디입니다 .다른 아이디를 사용해주세요</p>
				<div class="btn-area">
